...
//
//  Created by Eduardo Fornari on 11/04/18.
//  Copyright © 2018 Eduardo Fornari. All rights reserved.
//

import UIKit

internal protocol UIColorPickerViewDelegate : NSObjectProtocol {
...
class UIColorPickerView : UIView {
    ...
    weak internal var delegate: UIColorPickerViewDelegate?
